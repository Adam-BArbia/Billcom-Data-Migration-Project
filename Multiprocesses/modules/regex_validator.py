...
#  (__\\ 
#-----------------------------
#Found the one-line fix after hours of debugging
...
def validate_and_correct_data_chunk(chunk_path, output_path):
    df = pd.read_csv(chunk_path)
    df, invalid_correctable, invalid_non_correctable = validate_and_correct_data(df)
